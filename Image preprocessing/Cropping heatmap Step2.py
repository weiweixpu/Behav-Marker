...
input_folder = r'E:data\Open Field\Tenth\output1'  # Replace with the path to your input folder
output_folder = r'E:data\Open Field\Tenth\output2'  # Replace with the path to your output folder

# Call the function to process the PNG images
