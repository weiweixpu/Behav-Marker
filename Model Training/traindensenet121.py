...
def restruct_model(model, num_cls):
    ...
    model.classifier = nn.Sequential(
        nn.Dropout(0.3),
        nn.Linear(model.classifier.in_features, num_cls)
    )
...
def train(model, trainData, testData, validationData):
    ...
    for epoch in range(epoches):
        ...
        if vali_loss < best_vali_loss:
            ...
            torch.save(model.state_dict(), '/mnt/data/zhenyuan/save_model(outputs)/random_densenet121_TM.pth')
            epochs_no_improve = 0
        else:
            ...
            if epochs_no_improve >= patience:
                ...
                # Load the best model
                model.load_state_dict(torch.load('/mnt/data/zhenyuan/save_model(outputs)/random_densenet121_TM.pth'))
                break
...
if __name__ == '__main__':
    ...
    model_densenet121 = torchvision.models.densenet121(pretrained=False)
    num_cls = 2
    model = restruct_model(model_densenet121, num_cls)
    train_data = '/mnt/data/zhenyuan/dataset1/pretraining_dataset2/train'
    test_data = '/mnt/data/zhenyuan/dataset1/pretraining_dataset2/test'
    vali_data = '/mnt/data/zhenyuan/dataset1/pretraining_dataset2/validation'
