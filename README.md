...
### 📂 Data Structure
**Please Note:** 🧪 This study uses the Reworded Open Field 63007 experimental device (RWD Life Science Co., Ltd., Shenzhen, China). If you are using a different device for data collection, please make sure to preprocess your data into the same format as used in this project (Including but not limited to the color, shape of the image). ⚠️ Otherwise, the provided models may not work directly with your data — you may need to fine-tune or retrain the models to ensure compatibility. 🔧📊
