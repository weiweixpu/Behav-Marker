...
# Initialize a dictionary to store each vehicle's longitude and latitude data
track_data = {}

# Read data from a text file
with open('G:\\Track Dataset\\Urban Data Release\\Bus GPS.txt', 'r') as file:
    for line in file:
        parts = line.strip().split(',')
        if len(parts) == 5:
            _, _, vehicle_id, lon, lat = parts
...
tracking_folder = 'G:\\Tracking Dataset\\Urban Data Release\\Bus_GPS\\Tracking'
heatmap_folder = 'G:\\Tracking Dataset\\Urban Data Release\\Bus_GPS\\Heatmaps'
